  ...
  return (
    <footer className="bg-[#111111] text-white pt-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-y-12 gap-x-8 border-b border-[#2B2B2B] pb-14 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="border-b border-[#2B2B2B] py-10">
          <div className="flex flex-col items-center gap-6 text-center lg:flex-row lg:gap-6">
